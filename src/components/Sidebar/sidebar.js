...
import { collection, query, where, getDocs } from "firebase/firestore"; // Firestore query imports
import "./Sidebar.css";
import { FaHome, FaBriefcase, FaChalkboardTeacher, FaBlog, FaUser } from "react-icons/fa";
    ...
    <div className="sidebar">
      ...
      <nav className="title-nav">
        {menuItems.map((item, index) => (
          <Link key={index} to={item.link} onClick={() => handleItemClick(index)}>
            {item.title}
          </Link>
        ))}
      </nav>
